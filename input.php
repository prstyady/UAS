...
<?php
    ...
    {   
        ...
        // Update data
        $result = mysqli_query($conn, "INSERT INTO covid19 SET id='$id', jenisalokasi='$jenisalokasi', no='$no', Alokasi='$alokasi', jumlahtransaksi='$jumlahtransaksi', jumlahdana='$jumlahdana', nama='$nama', nim='$nim'");
